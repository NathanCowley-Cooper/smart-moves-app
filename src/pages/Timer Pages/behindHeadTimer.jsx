...
//Return Behind Head Stretch Timer Page
function BehindHeadTimerPage({match}) {
  useEffect(() => {
    console.log('match is', match.params.id)
    const getStretch = () => {
      //return a promise
      //fetch ergonomic.json
      fetch('https://smart-moves.herokuapp.com/api/office/5f90436a62025a600cfa4fbb')
        .then((res) => res.json())
        .then((stretch) => {
...
return (
  <div className="stretchPage">
      <Link to= "/routines/officestretches/5f605c919258f504a4067ad1/timer">
    ...
    <Link to= "/routines/officestretches/5f9043dd62025a600cfa4fbc/timer" className="timerLink" style={{textDecoration: 'none'}} >
        <div className="next_stretch">
        <div className= "stretchBox">
          <img src="/images/stretches/sideBend.jpg" className="routineStretchImage" alt="Stretch" />
        </div>
        <div className="nextStretch_info">
          <h5>Continue: Side Neck Bends</h5>
        </div>
      </div>
    </Link>
...
//Export Page
export default BehindHeadTimerPage;